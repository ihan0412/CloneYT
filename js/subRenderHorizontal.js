...
document.addEventListener('DOMContentLoaded', () => {
    const videoGrid = document.querySelector('.video-list-horizontal'); // .video-list-horizontal로 변경!
    ...
    if (videoGrid) { // 해당 요소가 존재할 때만 실행
        videoData.forEach(video => {
            ...
            colDiv.className = 'col-12 mb-3 d-flex justify-content-center';

            colDiv.innerHTML = `
                <div class="d-flex align-items-start align-items-center video-card-horizontal">
